...
<head>
    <title>HolyDude | Information</title>
...
<div class="wrap" id="info">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="info.php">Information<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="mt-5 mb-5">
        <div class="container">
            <h2 class="text-center" id="faq">Information</h2>
            <div class="row">
                <div class="col-md-9 mx-auto">
                    <div class="card">
                        <div class="card-body">
                                <h4>T-Shirt's Material</h4>
                                <h5>Cotton Combed 24s</h5>
                                <br>
                                <br>
                                <h4>Size Chart (CM)</h4>
                                <h5>S : Height x Width : 67 x 48</h5>
                                <h5>M : Height x Width : 71 x 50</h5>
                                <h5>L : Height x Width : 74 x 52</h5>
                                <h5>XL : Height x Width : 78 x 53</h5>
                                <br>
                                <br>
                                <h4>Design's Size (Custom)</h4>
                                <img src="img/size.PNG">
                                <br>
                                <br>
                                <br>
                                <h4>Multiple Design</h4>
                                <h5>Just compress all of the design pictures and give the size information 
                                    of each design.
                                </h5>
                        </div>
                    </div>
