...
<div class="wrap">
    ...
    <div class="jumbotron mb-1 rounded-0">
        <h1 id="nameacc" class="display-4">Thanks For Being HolyMate, <?php echo $_SESSION['username'];?>!</h1>
        <h3 class="text-center">This is Your Design</h3>
        <hr class="my-4">
        <div class="row">
          </div>
          <div class="row">
              <div class="col-md-7 offset-5 mt-5">
                <a class="btn btn-secondary btn-lg" id="continue" href="index.php" role="button">Continue Shopping</a>
            </div>
        </div>
      </div>
