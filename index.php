...
<head>
  <title>62Apparel | PROUDLY OF LOCAL WISDOM</title>
...
<body>
  ...
  <div class="wrap">
    ...
    <div class="alert alert-dark text-center" role="alert">
      <b>TRY TO BUY OUR T-SHIRT ITS SO COOL!
      ...
      <div class="row">
        ...
        <div class="col-md-3 offset-3">
          <div class="card mt-3" style="width: 15rem;">
            ...
            <div class="card-body">
              <h5 class="card-title">SURABAYA CITY</h5>
              <p class="card-text">Spesial Hari Pahlawan</p>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="single-features-ads first">
                  ...
                  <h4>Free Shipping</h4>
                  <p>Who the hell doesnt want a free shipping?</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="single-features-ads second">
                  <img src="img/icons/coin.png" alt="">
                  <h4>Affordable Cool T-Shirt</h4>
                  <p>Not only provides some cool catalogs, we made a incredible Shirts</p>
                </div>
              </div>
              <div class="col-lg-4">
