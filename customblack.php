			...
			<div class="row">
				<div class="col-lg-6">
					<div class="product-pic-zoom">
						<img class="product-big-img" src="img/custom1.jpg" alt="">
					</div>
					<div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
						<div class="product-thumbs-track">
							<div class="pt active" data-imgbigurl="img/custom1.jpg"><img src="img/custom1.jpg" alt=""></div>
							<div class="pt" data-imgbigurl="img/custom1back.jpg"><img src="img/custom1back.jpg" alt=""></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 product-details">
					<h2 class="p-title">Custom T-Shirt</h2>
                    ...
                    <a href="paymentcustom.php" class="site-btn mb-3">BUY NOW</a>
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-md-12 text-center copyright">
            <p class=""><small class="text-white-50 text-center">+62 Cloth © 2019. All rights reserved.</small></p>
          </div>
        </div>
      </div>
