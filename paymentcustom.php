...
<head>
    <title>62Apparel | Checkout Form</title>
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-8 offset-2">
                <form method="POST" action="datapaycus.php" enctype="multipart/form-data">
                        <div class="md-form ">
                       ...
                       <div class="input-group mt-3">
                        <select class="custom-select " name = "colour">
                        ...
                        <div class="input-group mt-3">
                          <select class="custom-select" name = "designf">
                            <option selected>(Choose Front Design Size)</option>
                            ...
                            <option value="MD">Multiple Design</option>
                          </select>
                      </div>

                      <div class="input-group mt-3">
                        <select class="custom-select" name = "designb">
                          <option selected>(Choose Back Design Size)</option>
                          <option value="None">None</option>
                          <option value="A3">A3</option>
                          <option value="A4">A4</option>
                          <option value="A5">A5</option>
                        ...
                        <div class="form-group mt-3">
                          <label>Upload Picture Design</label>
                          <input type="file" class="form-control-file" name = "design"  required="" />
                        </div>
                       <div>
                        <button class="btn btn-primary btn-lg btn-block mb-5" type="submit" name="submit" value="Submit">Submit</button>
                        </div>
                </form>
              </>
            </div>
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-md-12 text-center copyright">
            <p class=""><small class="text-white-50 text-center">+62Apparel © 2019. All rights reserved.</small></p>
          </div>
        </div>
      </div>
